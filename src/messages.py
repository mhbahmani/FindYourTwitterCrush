...
ACCESS_DENIED_MSG = """
بات هنوز به صورت عمومی در دسترس نیست و الان اولویت با کساییه که منو [mh_bahmani](https://twitter.com/mh_bahmani) فالو می‌کنن و منم فالوشون می‌کنم. صف که خالی‌تر شد، خبرت می‌کنم.
"""
