...
ACCESS_DENIED_MSG = """
درخواستت رو گرفتم و تو صف انتظار گذاشتم، ولی فعلا اولویت با کساییه که منو [mh_bahmani](https://twitter.com/mh_bahmani) فالو می‌کنن و منم فالوشون می‌کنم. صف که خالی‌تر شد، خبرت می‌کنم یا خروجی‌تو برات می‌فرستم.
اینو در نظر داشته باش که صف خیلیییی طولانی شده و شاید یه مقدار طول بکشه تا نتیجه‌ت حاضر بشه. به محض آماده شدنش برات می‌فرستمش.
"""
