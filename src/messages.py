...
ACCESS_DENIED_MSG = """
بات هنوز به صورت عمومی در دسترس نیست و الان فقط کسایی که منو [mh_bahmani](https://twitter.com/mh_bahmani) فالو می‌کنن و منم فالوشون می‌کنم می‌تونن ازش استفاده کنن. هر وقت بات در دسترس قرار گرفت، خبرت می‌کنم. فالوم کن که جا نمونی :)"""