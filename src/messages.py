...
ACCESS_DENIED_MSG = """
درخواستت رو گرفتم و تو صف انتظار گذاشتم، ولی اینو در نظر داشته باش که صف خیلیییییییی طولانی شده و شاید یه مقدار طول بکشه تا نتیجه‌ت حاضر بشه. به محض آماده شدنش برات می‌فرستمش.
ازون‌جایی هم که بات به صورت عمومی در دسترس نیست، در نتیجه اولویت با کساییه که منو [mh_bahmani](https://twitter.com/mh_bahmani) فالو می‌کنن و منم فالوشون می‌کنم. به مرور کارنامه‌ی عمل همرو براشون می‌فرستم :)
"""
