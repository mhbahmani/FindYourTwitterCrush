...
ACCESS_DENIED_MSG = """
بات هنوز به صورت عمومی در دسترس نیست و الان اولویت با کساییه که منو [mh_bahmani](https://twitter.com/mh_bahmani) فالو می‌کنن و منم فالوشون می‌کنم. هر وقت صف درخواست‌ها کوتاه‌تر شد، برای تو هم درست می‌کنم، یا خبرت می‌کنم که دوباره درخواست بدی."""
